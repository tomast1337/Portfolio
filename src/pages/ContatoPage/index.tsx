...
const ContatoElement = (props: { contato: Contato }) => {
  ...
  const links: Contato[] = [
    {
      ...
      icon: (
        ...
        >
          <g>
            <path
              fill={themeContext.isDarkMode ? colors.dark1 : colors.light1}
      ...
      icon: (
        ...
        >
          <g>
            ...
            />
            <path
              fill={themeContext.isDarkMode ? colors.light1 : colors.dark1}
